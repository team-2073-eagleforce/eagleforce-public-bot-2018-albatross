...
public class RightIntakePresetCommand extends AbstractLoggingCommand {
    ...
    @Inject
    public RightIntakePresetCommand(IntakePivotSubsystem intake, @Assisted double angle, @Assisted boolean isZeroingPID) {
        this.intake = intake;
        this.angle = angle;
