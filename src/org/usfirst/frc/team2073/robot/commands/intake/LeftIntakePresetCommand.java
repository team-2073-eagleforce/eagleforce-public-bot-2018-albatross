...
public class LeftIntakePresetCommand extends AbstractLoggingCommand {
    ...
    @Inject
    public LeftIntakePresetCommand(IntakePivotSubsystem intake, @Assisted double angle, @Assisted boolean isZeroingPID) {
        this.intake = intake;
        this.angle = angle;
